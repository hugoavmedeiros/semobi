...
8. **Aprendizado Contínuo:** Buscamos aprimorar constantemente nossas habilidades e conhecimentos para nos mantermos atualizados e eficazes na prestação de serviços de monitoramento estratégico.
    ...
    card(
      ...
      card_body(
        ...
        layout_column_wrap(
          ...
          value_box(
            title = "Diretora Jurídica (SEMOBI)",
          ...
          value_box(
            title = "Gerente Geral de Monitoramento (SEPE)",
            value = "Felipe Ferreira",
            theme = "info",
            showcase = tags$img(class = "mlk-userbox", src = "images/felipe.jpg"),
            p(bs_icon("envelope-at-fill"), "felipe.ferreira@sepe.pe.gov.br")
          ),
          value_box(
            title = "Superintendente de Mobilidade (SEMOBI)",
            value = "Hugo Medeiros",
            theme = value_box_theme(bg = "#66bad6",fg = "white"),
            showcase = tags$img(class = "mlk-userbox", src = "images/hugo.png"),
            p(bs_icon("envelope-at-fill"), "hugo.vasconcelos@semobi.pe.gov.br")
          ),
          value_box(
    ...
    card(
      full_screen = TRUE,
      card_header("Colaboradores", class = "bg-secondary"),
      card_body(
        class = "cards_sobre",
        layout_column_wrap(
          fill = FALSE,
          width = "475px", gap = "1rem",
          value_box(
            title = "Gerente Geral de Administração (SEMOBI)",
            value = "Amanda Oliveira",
            theme = "text-dark",
            showcase = tags$img(class = "mlk-userbox", src = "images/amanda2.jpg"),
            p(bs_icon("envelope-at-fill"), "amanda.deoliveira@semobi.pe.gov.br")
          ),
          value_box(
            title = "DataViz Sênior (Tesouro Nacional)",
            value = "Tiago Maranhão Barreto Pereira",
            theme = "text-dark",
            showcase = tags$img(class = "mlk-userbox", src = "images/tiago.jpg"),
            p(bs_icon("envelope-at-fill"), "tiago.pereira@tesouro.gov.br")
          )
        )
      )
    )
